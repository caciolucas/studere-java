...
public abstract class AuthenticationService<T extends User, R extends UserRepository<T>> {
    private final R userRepository;
    private final PasswordEncoder passwordEncoder;
    private final JwtTokenProvider jwtTokenProvider;

    public AuthenticationService(R userRepository, PasswordEncoder passwordEncoder, JwtTokenProvider jwtTokenProvider) {
